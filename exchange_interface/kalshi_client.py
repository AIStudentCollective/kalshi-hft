# Adapted from https://github.com/Kalshi/kalshi-starter-code-python/blob/main/clients.py
...
from exchange_interface.packet_processor import Processor
...
class KalshiWebSocketClient(KalshiBaseClient):
    ...
    async def run(self):
        ...
        websocket = await websockets.connect(host, additional_headers=auth_headers)
        self.ws = websocket
    ...
    async def on_message(self, message):
        ...
        normalized_packet = Processor.process_kalshi(message)
        # Push over message queue
        self.zmq_socket.send_pyobj(normalized_packet)
